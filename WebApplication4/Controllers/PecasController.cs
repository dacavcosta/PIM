...
namespace WebApplication4.Controllers
{
    public class PecasController : Controller
    {
        ...
        public PecasController(FrotasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([FromForm] Peca peca)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [FromForm] Peca peca)
        {
            if (id != peca.Id)
            {
                return NotFound();
